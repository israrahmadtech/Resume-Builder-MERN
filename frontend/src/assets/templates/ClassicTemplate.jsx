...
const ClassicTemplate = ({ data, accentColor }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-7 bg-white text-gray-800 leading-relaxed">
              ...
              <a
                ...
                href={
                  data.personal_info?.linkedin.startsWith("https://")
                    ? data.personal_info?.linkedin
                    : `https://linkedin.com/in/${data.personal_info?.linkedin}`
                }
                className="flex items-center gap-1"
              >
              ...
              <a
                ...
                href={
                  data.personal_info?.github.startsWith("https://")
                    ? data.personal_info?.github
                    : `https://github.com/${data.personal_info?.github}`
                }
                className="flex items-center gap-1"
              >
        ...
        <section className="mb-1">
          ...
          <div className="space-y-2">
            {data.experience.map((exp, index) => (
              <div
                key={index}
                className="border-l-3 pl-4 border-gray-300"
              >
      ...
      <ExtraSections sections={data.additional_sections} accentColor={accentColor} />
    </div>
  );
};
