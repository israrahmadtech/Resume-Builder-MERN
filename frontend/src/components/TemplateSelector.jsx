  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-1 text-sm text-[#8e51ff] bg-[#8e51ff]/10 ring-[#8e51ff]/25 hover:ring transition-all px-3 py-2 rounded-lg"
      >
            ...
            <div
              ...
              className={`relative p-3 border rounded-md cursor-pointer transition-all ${
                selectedTemplate === template.id
                  ? "border-[#8e51ff] bg-[#8e51ff]/10"
                  : "border-gray-300 hover:border-gray-400 hover:bg-gray-100"
              } `}
            >
              {selectedTemplate === template.id && (
                <div className="absolute top-2 right-2">
                  <div className="size-5 bg-[#8e51ff] rounded-full flex items-center justify-center">
              ...
              <div className="space-y-1">
                ...
                <div className="mt-2 p-2 bg-slate-50 rounded text-xs text-gray-500 italic">
                  {template.preview}
                </div>
              </div>
            </div>
